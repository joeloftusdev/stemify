...
Stemify is a Windows desktop application that leverages [Spleeter](https://github.com/deezer/spleeter) to split songs(.wav) into individual instrument tracks.
## How to Build
```
